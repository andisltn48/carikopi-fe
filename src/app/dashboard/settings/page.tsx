  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Kelola preferensi dan alat bantu toko Anda</p>
      </div>

      <div className="bg-card rounded-2xl shadow-sm border border-border/60 overflow-hidden">
        <div className="p-6 border-b border-border bg-surface-container-low/30">
          <h2 className="text-lg font-bold text-foreground">QR Code Toko</h2>
          <p className="text-sm text-muted-foreground">Gunakan QR code ini untuk memudahkan pelanggan memesan di tempat.</p>
        </div>
